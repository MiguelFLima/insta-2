          ...
          <div className="relative mt-1 p-3 rounded-md ">
            ...
            <input
              ...
              className="bg-gray-50 block w-full pl-10 sm: text-sm
                        focus:ring-black focus:border-black border-gray-300 rounded-md"
            />
          </div>
        </div>
          ...
          {session ? (
            <>
              <div className="relative navBtn">
                ...
                <div className="absolute text-white -top-2 -right-2 text-xs w-5 h-5 bg-red-500 rounded-full flex items-center justify-center animate-pulse">
                  3
                </div>
              </div>
              <PlusCircleIcon
