...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    // upload image to firebase store with the post ID
    // get a download URL from firebase store and update to original post
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    className="inline-flex justify-center w-full rounded-md border 
                      ...
                      disable:bg-gray-300 disable:cursor-not-allowed hover:disable:bg-gray-300"
